...
const Page2 = () => {
  ...
  return (
    <div id="page2Texts" className="min-h-screen  p-10 text-center">
      <p className="font-[anzo2] text-gray-500 text-[1.3vw]">
        © anzo.studio 2025 | designed and developed
      </p>
      <div
        id="page2Texts"
        className="uppercase text-[41vw] font-[anzo1] leading-[33vw] mt-20"
      >
        <h1 className="rotateText headingone">impactful</h1>
        <h1 className="rotateText ">design</h1>
        <h1 className="rotateText ">is the</h1>
        <h1 className="rotateText ">design</h1>
        <h1 className="rotateText ">that</h1>
        <h1 className="rotateText ">works!</h1>
      </div>

      <div id="svg-container" className="flex items-center justify-center scale-75" >
        <svg
      ...
      <div className="line relative h-0.5 w-1/3 bg-black left-1/2 -translate-x-1/2 mt-10" ></div>
    </div>
  );
};
